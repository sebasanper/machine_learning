...
def run():
    ...
    nn = MLPRegressor(
        hidden_layer_sizes=(500, 500, 200), activation='relu', solver='adam', alpha=0.0001, batch_size='auto',
        learning_rate='adaptive', learning_rate_init=0.001, power_t=0.5, max_iter=4000, shuffle=False,
    ...
    with open("regressor_coords3x3_time.pickle", 'wb') as out:
        pickle.dump(nn, out)

    nn = pickle.load(open('regressor_coords3x3_time.pickle', 'rb'))
